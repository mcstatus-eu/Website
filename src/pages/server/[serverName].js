            ...
            <div className="flex items-end">
              <button 
                ...
                className={`px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold transition-all duration-300 ${
                  loading || !router.isReady ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-lg'
                }`}
              >
                {loading ? (
                  ...
                  {serverData.favicon && (
                    <div className="mb-6 text-center">
                      <img 
                        ...
                        alt="Server Icon" 
                        className="w-16 h-16 rounded-lg shadow-lg mx-auto"
                ...
                <div className={`rounded-2xl p-8 transition-all duration-300 ${
                  ...
                  {serverData.players.list && serverData.players.list.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className={`font-semibold mb-2 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
